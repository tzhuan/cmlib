...
// global I/O routines
extern unsigned char *readBMP(const char *fname, int& width, int& height, int &depth);
extern bool writeBMP(const char *fname, unsigned char *data, int width, int height, int depth); 
