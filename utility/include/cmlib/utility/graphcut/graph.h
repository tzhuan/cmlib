...
public:
	...
	Graph(int node_num_max, int edge_num_max, void (*err_function)(const char *) = NULL) : node_num(0),
	  nodeptr_block(NULL),
	...
	~Graph()
{
	...
	flowtype maxflow(bool reuse_trees = false, Block<node_id>* _changed_list = NULL)
{
